  ...
  <div className='max-w-full w-full mx-auto '>
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-0 mt-10'>
      <div className='flex justify-center items-center'>
        <img src="/assets/systemconf.png" alt="Description" className="w-full h-[300px] object-cover rounded-none" />
      </div>

      <div className='flex flex-col justify-center bg-gray-200 p-6 rounded-none h-[300px]'>
        <p className=' ml-5 text-1xl md:text-3xl my-5 text-[#3C486B] font-bold'> If Would Like to get updates;</p>
        <form className='grid grid-cols-1 xl:grid-cols-2 gap-2 h-full md:ml-[100px]'>
